...
public class MainAdapter extends FirebaseRecyclerAdapter<MainModel, MainAdapter.myViewHolder> {
    ...
    protected void onBindViewHolder(@NonNull myViewHolder holder, @SuppressLint("RecyclerView") final int position, @NonNull MainModel model) {
        ...
        holder.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EditText duration = view.findViewById(R.id.txtDuration);
                ...
                btnUpdate.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        FirebaseDatabase.getInstance().getReference().child("Subscriptions")
        ...
        holder.btnSelect.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                final DialogPlus dialogPlus = DialogPlus.newDialog(holder.img.getContext())
                        .setContentHolder(new ViewHolder(R.layout.activity_checkout))
    ...
    class myViewHolder extends RecyclerView.ViewHolder{
        CircleImageView img;
        TextView name, duration, price;

        Button btnEdit, btnDelete, btnSelect, conBtn;
        ...
        public myViewHolder(@NonNull View itemView) {
            ...
            conBtn = (Button)itemView.findViewById(R.id.continueBtn);
        }
    }
}
